...
#'rotated_pVals_thresh_fdr0.05_inverted'
#'perception_pVals_thresh_fdr0.05_inverted'
#'schema_pVals_thresh_fdr0.05_inverted'
...
for CurrSub in range(len(AllSubjects)):
    ...
    for currWhichWedd in WhichWeddNrs:
        ...
        # select TRs only for templates
        TotalDataAllWedds_copy = TotalDataAllWedds_copy.loc[TotalDataAllWedds_copy['TRidx'] > EndEvent1]
        TotalDataAllWedds_copy = TotalDataAllWedds_copy.loc[TotalDataAllWedds_copy['TRidx'] < EndEvent2]
    ...
    sameEv_otherSchema_all2.to_csv(output_dir + 'indivFiles/' + ROI_name + '_' + str(AllSubjects[CurrSub]) + '_rsa_sameEv_otherSchema_norm_event2Templates.csv')
    otherEv_otherSchema_all2.to_csv(output_dir + 'indivFiles/' + ROI_name + '_' + str(AllSubjects[CurrSub]) + '_rsa_otherEv_otherSchema_norm_event2Templates.csv')
    otherEv_sameSchema_all2.to_csv(output_dir + 'indivFiles/' + ROI_name + '_' + str(AllSubjects[CurrSub]) + '_rsa_otherEv_sameSchema_norm_event2Templates.csv')
    sameEv_sameSchema_all2.to_csv(output_dir + 'indivFiles/' + ROI_name + '_' + str(AllSubjects[CurrSub]) + '_rsa_sameEv_sameSchema_norm_event2Templates.csv')
...
sameEv_otherSchema_group.to_csv(output_dir + ROI_name + '_rsa_sameEv_otherSchema_norm_event2Templates.csv')
otherEv_otherSchema_group.to_csv(output_dir + ROI_name + '_rsa_otherEv_otherSchema_norm_event2Templates.csv')
otherEv_sameSchema_group.to_csv(output_dir + ROI_name + '_rsa_otherEv_sameSchema_norm_event2Templates.csv')
sameEv_sameSchema_group.to_csv(output_dir + ROI_name + '_rsa_sameEv_sameSchema_norm_event2Templates.csv')
