...
for CurrSub in range(len(AllSubjects)):
    ...
    TotalDataAllWedds.to_csv(output_dir + ROI_name + '_TotalDataAllWedds.csv')
    ...
    for currWhichWedd in WhichWeddNrs:
        ...
        sameEv_otherSchema_all.to_csv(output_dir + ROI_name + '_sameEv_otherSchema_all.csv')
    ...
    sameEv_otherSchema_all2.to_csv(output_dir + 'indivFiles/' + ROI_name + '_' + str(AllSubjects[CurrSub]) + '_rsa_sameEv_otherSchema_norm_event3Templates.csv')
    otherEv_otherSchema_all2.to_csv(output_dir + 'indivFiles/' + ROI_name + '_' + str(AllSubjects[CurrSub]) + '_rsa_otherEv_otherSchema_norm_event3Templates.csv')
    otherEv_sameSchema_all2.to_csv(output_dir + 'indivFiles/' + ROI_name + '_' + str(AllSubjects[CurrSub]) + '_rsa_otherEv_sameSchema_norm_event3Templates.csv')
    sameEv_sameSchema_all2.to_csv(output_dir + 'indivFiles/' + ROI_name + '_' + str(AllSubjects[CurrSub]) + '_rsa_sameEv_sameSchema_norm_event3Templates.csv')
...
sameEv_otherSchema_group.to_csv(output_dir + ROI_name + '_rsa_sameEv_otherSchema_norm_event3Templates.csv')
otherEv_otherSchema_group.to_csv(output_dir + ROI_name + '_rsa_otherEv_otherSchema_norm_event3Templates.csv')
otherEv_sameSchema_group.to_csv(output_dir + ROI_name + '_rsa_otherEv_sameSchema_norm_event3Templates.csv')
sameEv_sameSchema_group.to_csv(output_dir + ROI_name + '_rsa_sameEv_sameSchema_norm_event3Templates.csv')
...
plt.savefig(output_dir + ROI_name + '_rsa_norm_event3Templates.png')
